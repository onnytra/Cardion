...
<body>
    <div>
                ...
                <div class="w-full grid grid-cols-1 lg:grid-cols-2 py-36 pr-24 mx-auto lg:py-32 md:px-48">
                    ...
                    <div class="md:text-center pl-0 md:pl-20 lg:pl-0">
                        ...
                        <p
                            ...
                            The Cardion Olympiad 2025 theme is Sensory System. Cardion Olympiad consist of three rounds,
                            there are preliminary, semifinal, and final. The preliminary round will be held in 6 cities
                            in Indonesia by offline and centered by online. The semifinal and final round will be held
                            in Malang.
                        </p>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 mt-5">
                        <div class="bg-[#F7EEDD] text-left p-8 rounded-tl-[60px] rounded-br-[60px]">
                            ...
                            <div class="bg-[#FABE84] mt-2 px-5 py-2 rounded-lg text-center">
                                <p class="text-xl font-andalus">Rp125.000,-</p>
                            </div>
                        ...
                        <div class="bg-[#F7EEDD] text-left p-8 rounded-tr-[60px] rounded-bl-[60px]">
                            ...
                            <div class="bg-[#FABE84] mt-2 px-5 py-2 rounded-lg text-center">
                                <p class="text-xl font-andalus">Rp135.000,-</p>
                            </div>
                            <p class="text-lg font-abhaya mt-2">
        ...
        <div id="contact" class="min-h-screen px-6 pt-5 lg:px-8 bg-page-9 bg-right-top bg-cover">
            <div class="max-w-6xl py-10 mx-auto lg:py-20">
                <h1 class="text-[3rem] text-white font-asian-ninja text-center leading-tight sm:text-[4.2rem]">
                    Get in Touch
                </h1>
                    ...
                    <div class="text-center text-white lg:text-left">
                        <div class="flex flex-col items-center lg:items-start ">
                            ...
                            <a href="https://maps.app.goo.gl/1cu3BuASRms5WsFJ8" target="_blank"
                                ...
                                class="block mt-5 w-40 text-center rounded-xl text-gray-900 font-andalus bg-[#D9D9D9] py-2 text-lg shadow-sm hover:bg-red-500 hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600 focus-visible:text-white transition ease-in-out">
                                View Location
                            </a>
                        </div>
                        <div class="mt-12">
