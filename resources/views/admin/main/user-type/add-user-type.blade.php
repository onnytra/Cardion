<x-layout>
    ...
    <div class="card mt-6">
        ...
        <form id="main-form" action="{{ route('dashboard.user-type.store') }}" method="POST">
            @csrf
                        ...
                        <div class="flex items-center gap-4 mb-5">
                            ...
                            <div class="lg:w-full">
                                <div class="relative inline-block w-10 mr-2 align-middle select-none transition duration-200 ease-in">
                                    <input type="checkbox" name="status_role" id="toggle" value="1" {{ old('status_role') == 1 ? 'checked' : '' }} class="toggle-checkbox absolute block w-6 h-6 rounded-full bg-white border-4 appearance-none cursor-pointer transition-colors duration-500" />
                            ...
                            <div class="grid gap-6">
                                ...
                                <div class="flex items-center gap-5">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <input type="checkbox" id="permission[{{ $permission->id }}]" name="permission[{{ $permission->id }}]" value="{{ $permission->name }}" class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
                                        <div class="w-20">
