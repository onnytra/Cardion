                    ...
                    <div id="tab-2" class="hidden form-tab">
                        ...
                        <div class="flex items-center gap-5">
                            ...
                            <div class="flex items-center gap-2">
                                <input type="checkbox" id="{{ $permission->name }}" name="{{ $permission->name }}" value="{{ $permission->name }}" class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
                                <div class="w-20">
