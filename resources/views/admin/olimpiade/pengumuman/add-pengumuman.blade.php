                ...
                <div class="grid gap-6">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <select id="tipe_pengumuman" name="tipe_pengumuman"
                            ...
                            <option class="font-medium text-sm" value="broadcast" {{ old('tipe_pengumuman') == 'broadcast' ? 'selected' : '' }}>Broadcast</option>
                            <option class="font-medium text-sm" value="gelombang" {{ old('tipe_pengumuman') == 'gelombang' ? 'selected' : '' }}>Berdasarkan Gelombang Pembayaran</option>
                        </select>
                    </div>
                    <div class="flex items-center gap-4" id="gelombang_section" style="display: none;">
                        ...
                        <select id="gelombang" name="gelombang"
                            ...
                            <option class="font-medium text-sm" value="{{ $data->id_gelombang }}" {{ old('gelombang') == $data->id_gelombang ? 'selected' : '' }}>{{ $data->gelombang }}</option>
                            @endforeach
                        </select>
                    </div>
                    <hr>
                    <div>
                        ...
                        <textarea name="deskripsi" id="classic-editor"
                            class="flex-grow w-full shadow-sm text-sm rounded-md" required>{{ old('deskripsi') }}</textarea>
                    </div>
                    <div class="flex items-center gap-4">
                        <div class="w-56">
                        ...
                        <input type="checkbox" name="status_pengumuman" id="toggle" value="1" {{ old('status_pengumuman') ? 'checked' : '' }}
