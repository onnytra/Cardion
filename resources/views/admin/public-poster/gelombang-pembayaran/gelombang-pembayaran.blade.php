<x-layout>
    ...
    <div class="card mt-6">
        <div class="card-header flex flex-row justify-between items-center">
            <h1 class="h6">Daftar Gelombang Pembayaran Public Poster</h1>
            <button>
                <a href="/admin/public-poster/gelombang-pembayaran/add" class="btn-bs-dark">
                                            ...
                                            <div class="sm:flex sm:items-start">
                                                <div class="cart mt-1 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                                    <div class="card-body relative overflow-x-visible sm:rounded-lg">
                                                        <button class="w-full">
                                                            <a href="/admin/public-poster/gelombang-pembayaran/edit"
