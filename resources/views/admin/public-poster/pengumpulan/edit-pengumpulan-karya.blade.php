<x-layout>
    ...
    <div class="card mt-6">
        <div class="card-header">
            <h1 class="h6">Form Edit Pengumpulan Karya</h1>
        </div>

        <form action="{{route('poster.pengumpulan_karya.update', $pengumpulan_karyas->id_pengumpulan)}}" method="POST">
            @csrf
            @method('PUT')
            <div class="card-body relative overflow-x-auto sm:rounded-lg">
                <div class="grid gap-6">
                    <div class="flex items-center gap-4">
                        ...
                        <input type="text" name="judul" id="judul" value="{{ $pengumpulan_karyas->judul }}"
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <input type="date" name="mulai" id="mulai" value="{{ $pengumpulan_karyas->mulai }}"
                            class="p-2 border border-gray w-full lg:w-full shadow-sm text-sm rounded-md" required>
                            <input type="time" name="waktu_mulai" id="mulai" value="{{ $pengumpulan_karyas->waktu_mulai }}"
                                class="p-2 border border-gray w-full lg:w-full shadow-sm text-sm rounded-md" required>
                    </div>
                    <div class="flex items-center gap-4">
                        <div class="w-56 ">
                        ...
                        <input type="date" name="berakhir" id="berakhir" value="{{ $pengumpulan_karyas->berakhir }}"
                            class="p-2 border border-gray w-full lg:w-full shadow-sm text-sm rounded-md">
                            <input type="time" name="waktu_berakhir" id="mulai" value="{{ $pengumpulan_karyas->waktu_berakhir }}"
                                class="p-2 border border-gray w-full lg:w-full shadow-sm text-sm rounded-md" required>
                    </div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="w-full">
                            <div
                                ...
                                <input type="checkbox" name="status_pengumpulan" id="toggle" value="1" {{ $pengumpulan_karyas->status_pengumpulan ? 'checked' : '' }}
